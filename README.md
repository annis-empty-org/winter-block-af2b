...
```
npm create cloudflare@latest -- --template=cloudflare/templates/winter-block-af2b
```

## Preview Deployment

A live public deployment of this template is available at [https://winter-block-af2b.templates.workers.dev](https://winter-block-af2b.templates.workers.dev)
